...
class FinancialOperationModel(models.Model):
    ...
    operation_type = models.CharField(choices=OperationTypes.choices, max_length=8)
    operation_class = models.CharField(choices=OperationClasses.choices, max_length=9)
    ...
    broker = models.ForeignKey("BrokerModel", on_delete=models.PROTECT)
